...
<section class="container mx-auto p-0 mt-0">
    ...
    <section class="container mx-auto p-0">
      <h2 class="text-xl font-semibold mb-4 p-4">Job Details</h2>
      ...
      <a
        ...
        class="block w-full text-center px-0 py-2.5 shadow-sm rounded border text-base font-medium cursor-pointer text-indigo-700 bg-indigo-100 hover:bg-indigo-200"
      >
        Apply Now
      </a>
    </section>
