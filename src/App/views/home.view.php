          ...
          <div class="w-fit rounded-lg shadow-md bg-white">
            <div class="p-4">
              ...
              <a href="/listings/<?= $listing->id ?>"
                class="block w-fit text-center px-4 py-2.5 shadow-sm rounded border text-base font-medium text-indigo-700 bg-indigo-100 hover:bg-indigo-200"
              >
                Details
              </a>
            </div>
